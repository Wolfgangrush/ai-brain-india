# Contributing to AI Brain — India

Thanks for wanting to help. **AI Brain — India** is open source (MIT). Contributions of all sizes are welcome — typo fixes, statute-corpus corrections, new drafting templates, agent improvements, and translations.

## Getting started

```bash
git clone https://github.com/Wolfgangrush/ai-law-firm-india.git
cd ai-law-firm-india
pip install -e ".[dev]"
```
...
```
ailawfirm_india/   ← core package (see ailawfirm_india/README.md for the module/agent guide)
tests/         ← test suite

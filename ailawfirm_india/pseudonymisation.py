...
§3.V4 (Data Protection — DPDP Act 2023) + §6.D4 (no telemetry, ever) +
§3.V9 (Conduct-Rule Inducement — BCI Rule 17 confidentiality).
...
Usage:
    from ailawfirm_india.pseudonymisation import PseudonymisationGateway
...
# ─────────────────────────────────────────────────────────────────────────
# Regex patterns — INDIA-SPECIFIC government IDs + structured identifiers
# ─────────────────────────────────────────────────────────────────────────

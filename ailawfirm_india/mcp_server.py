...
from .mcp_tools.court_lookup import india_court_lookup
from .mcp_tools.citation_validator import india_citation_validator
...
TOOLS = {
    ...
    "india_court_lookup": {
        "description": "Look up an Indian court by name (fuzzy match). Returns court type, jurisdiction class, location, and applicable procedural code. v0.1 covers Supreme Court, Bombay HC (Mumbai + Aurangabad Bench), District Court Aurangabad, and DRT Aurangabad.",
        "input_schema": {
            "type": "object",
            "properties": {
                "court_name": {
                    "type": "string",
                    "description": "Court name to look up (e.g. 'Bombay High Court Aurangabad Bench', 'supreme court', 'DRT Aurangabad')",
                },
            },
            "required": ["court_name"],
        },
        "handler": india_court_lookup,
    },
    "india_citation_validator": {
        "description": "Parse and validate an Indian legal citation. Recognizes 3 formats: AIR (All India Reporter), SCC (Supreme Court Cases), and SCC OnLine. v0.1 validates format only; database lookup lands in v0.3+.",
        "input_schema": {
            "type": "object",
            "properties": {
                "citation_string": {
                    "type": "string",
                    "description": "Citation string (e.g. 'AIR 1973 SC 1461', '(2023) 4 SCC 121', '2024 SCC OnLine Bom 891')",
                },
            },
            "required": ["citation_string"],
        },
        "handler": india_citation_validator,
    },
}
    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "brain", "version": "2.0.0"},
            },
        }

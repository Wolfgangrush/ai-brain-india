...
# Loaded from ~/.ailawfirm-india/known_names.json if it exists, otherwise generic fallback.
...
def _load_known_people() -> list:
    ...
    if _KNOWN_NAMES_PATH.exists():
        try:
            ...
            pass
    # Generic fallback — override by creating ~/.ailawfirm-india/known_names.json
...
def extract_people(lines):
    ...
    if dir_match:
        ...
        # User can map usernames to names in ~/.ailawfirm-india/known_names.json

...
Usage from CLI:
    ailawfirm-india connect-local
    ailawfirm-india connect-local --yes      # skip prompts
    ailawfirm-india connect-local --model qwen3:7b   # force a specific model

Result: ~/.ailawfirm-india/config.json is written with ai_provider=ollama and the
...
def install_ollama_instructions() -> None:
    ...
    print()
    print("Then run `ailawfirm-india connect-local` again.")
...
def cmd_connect_local(args) -> int:
    ...
    print("  ailawfirm-india connect-cloud --provider deepseek --cloud-warning-acknowledged")
    print()
    return 0

...
Usage:
    python3 -m ailawfirm_india.onboarding
    or: brain init
"""
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.ailawfirm-india/alias_entities.md")
    print("  Critical facts bootstrap: ~/.ailawfirm-india/critical_facts.md")
